...
function updateDropOffLocations(city) {
  const locations = {
    ...
    'Mumbai': [
      ...
      { name:'Masstech Recycling LLP',address : 'Gala No. 56, 58, 59 & 82, M.J.K. Compound, Kherani Road, Sakinaka, Mumbai  400072' , rating: '3.8*',wasterecycledlastmonth: '2800kg',contact: '9854090758', email: 'masstech300@gmail.com',time: '9:00 AM - 6:00 PM'}
